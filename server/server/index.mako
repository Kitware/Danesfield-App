...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${staticRoot}/built/plugins/vaui/vaui.min.css">
  ...
  <body>
    ...
    ## which allows Vaui to be extended by other plugins and have the
    ...
    % for plugin in pluginJs:
        ...
        % else:
            ## We don't want to serve the plugin.min.js resource for Vaui
            ## since this is related to the Girder Admin configure plugins page for Vaui.
            <script src="${staticRoot}/built/plugins/vaui/vaui.min.js"></script>
        % endif
    % endfor
